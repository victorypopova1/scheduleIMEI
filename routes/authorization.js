...
router.get('/personalAccount', isLoggedIn, function(req, res, next) {
    ...
    res.render('authorization/personalAccount', { title: 'Личный кабинет', username: username , lastname: lastname, firstname: firstname, patronymic: patronymic, type_user: type_user,email:email });
});
